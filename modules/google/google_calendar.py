...
def authorization():
    ...
    if not creds or not creds.valid:
        if creds and creds.expired and creds.refresh_token:
            ...
            path_to_credentials = abspath(join(__file__, '..',  '..', '..', 'static', 'google_settings','credentials.json'))
        ...
        path_to_token = abspath(join(__file__, '..', '..', '..', 'static', 'google_settings', 'token.json'))
